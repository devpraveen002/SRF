...
//    // Save button click event with improved double-click prevention
...
//        // Format the date correctly for .NET binding
...
//        const studentData = {
//            // Remove Id when creating a new student
//            ...(studentId != "0" && { Id: parseInt(studentId) }),
//            Name: $("#name").val().trim(),
...
//                $("#successMessage").hide();
//            },
//            // Add a complete handler as a final safeguard
//            complete: function () {
//                // Make absolutely sure the submission status is reset
//                setTimeout(function () {
//                    isSubmitting = false;
//                    $("#saveBtn").prop('disabled', false);
//                }, 500);
...
//        // Ensure the save button is enabled and submission status is reset
//        isSubmitting = false;
//        $("#saveBtn").prop('disabled', false);
//    }
//});
